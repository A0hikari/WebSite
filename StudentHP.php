<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($dbcon, "SELECT * FROM studentuser WHERE username = '$username' AND password = '$password'");
        ...
        if ($row) {
            ...
            header("location:./WebDevST/home-page.html");
        } else {
            $msg = "Invalid Login";
        }
    }
    ...
    <a href="./HPlogin.html" class="back">&#8592;</a>
        ...
        <?php if(isset($msg)) { ?>
            ...
            <div class="input-control">
                ...
                <input type="text" placeholder="Enter your student ID" id="username" name="username"
